                ...
                <div className="flex items-start gap-2">
                    ...
                    <div className="relative group shrink-0">
                        ...
                        <div
                            ...
                            "
                        >
                            This assistant responds using my curated personal knowledge base.<br/>
                            It does not collect, store, or retain personal information.<br/>
                ...
                <div className="flex items-center gap-3">
                    ...
                    {status && (
                        <span className="text-xs text-white/50">
                            {status}
                            {loading && status.toLowerCase().includes("generating")
                                ? ".".repeat(dotCount)
                                : null}
                        </span>
                    )}
