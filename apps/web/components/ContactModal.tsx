    ...
    return (
        <>
            <button
                type="button"
                onClick={openModal}
                className="group inline-flex items-center gap-2 cursor-pointer text-white/60 hover:text-white"
            >
                ...
                <div className="p-6 sm:p-8">
                    <div className="flex items-start justify-between gap-6">
                        ...
                        <button
                            type="button"
                            onClick={closeModal}
                            className="text-sm cursor-pointer text-white/50 hover:text-white"
                            aria-label="Close"
                        >
                            Close
                        </button>
